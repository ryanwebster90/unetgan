...
def main():
    ...
    parser.add_argument("--learn_ratio",type=float, default=1)
    ...
    print(config['weights_root'])
    print(config['learn_ratio'])
    print(config['name'])
    config['name'] = config['name'].split('/')[-1][:-3]
    print(config['name'])
#     return
    config["base_root"] = 'results/' + config['name']
    new_root = config["base_root"]
    print(new_root)
